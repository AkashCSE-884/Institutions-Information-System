...
if(isset($_POST['submit'])){
  ...
  if ($num==0){
    ...
    yA1,y2,yp2,yA2,y3,yp3,yA3,ratings,image,mapUrl,areadetails,details,dateTime,number1,tstd)
    VALUES('$dis','$sub','$select','$ename','$tsum','$y1','$yp1','$tA1','$y2','$yp2',
    '$tA2','$y3','$yp3','$tA3','$ratings','$image','$website','$eadetails',' $message','$a','$number','$tstd')";

    $sql2="INSERT into tbratings(i_name,tblocation,tbimage,tbratting,types,tbabout)
    values('$ename','$sub','$image','$ratings','$select','$message')";
